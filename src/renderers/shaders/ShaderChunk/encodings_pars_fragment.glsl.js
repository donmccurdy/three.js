...
// XYZ_TO_DISPLAY_P3 x SRGB_TO_XYZ (http://www.russellcottrell.com/photo/matrixCalculator.htm)
mat3 SRGB_TO_DISPLAY_P3 = mat3(
...
vec4 LinearToDisplayP3( in vec4 value ) {
	...
	return vec4( LinearTosRGB( value ).rgb * SRGB_TO_DISPLAY_P3, value.a );
